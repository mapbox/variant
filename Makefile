...
out/unit: out/unit.o out/binary_visitor.o out/issue21.o out/mutating_visitor.o out/optional.o out/recursive_wrapper.o out/unary_visitor.o out/variant.o
	mkdir -p ./out
	$(CXX) -o $@ $^ $(LDFLAGS)
